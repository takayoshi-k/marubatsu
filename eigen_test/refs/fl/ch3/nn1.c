...
/*　出力層ニューロンの学習 　　　　　　　　　            */
/* 使い方　                                            　*/
/* C:\Users\odaka\ch3>nn1< (学習データセットのファイル名)*/
...
/*関数のプロトタイプの宣言*/
void initwo(double wo[INPUTNO+1]) ;/*出力層の重みの初期化*/
...
void olearn(double wo[INPUTNO+1],double e[INPUTNO+1],
                         double o) ; /*出力層の重みの学習*/
void printweight(double wo[INPUTNO+1]) ; /*結果の出力*/
